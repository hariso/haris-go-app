...
func (a App) Run(v turbine.Turbine) error {
	...
	source, err := v.Resources("es-demo")
	if err != nil {
		return err
	}
	...
	rr, err := source.Records("my-index-000001", nil)
	if err != nil {
		return err
	}
	...
	// data store was configured with on Meroxa
	dest, err := v.Resources("mongo-demo")
	if err != nil {
		return err
	}
	...
	// or bucket name in your data store
	err = dest.Write(res, "turbine-from-elasticsearch", nil)
	if err != nil {
		return err
	}
